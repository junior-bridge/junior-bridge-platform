...
export default function ReportsPage() {
  ...
  const reports = user.role === "tester" ? testerReports : user.role === "emprendedor" ? emprendedorReports : adminReports;
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            {user.role === "emprendedor" && "Bugs reportados en tus proyectos"}
